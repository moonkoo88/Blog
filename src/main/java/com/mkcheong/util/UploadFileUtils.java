...
public class UploadFileUtils {
     ...
     * @throws IOException
     */
    public static void fileDelete(String uploadPath) throws IllegalStateException, IOException {
    ...
    //업로드 파일 확장자 체크
    public static boolean isValidExtension(String originalName) {
        String originalNameExtension = originalName.substring(originalName.lastIndexOf(".") + 1).toUpperCase();
